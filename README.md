...
# Тесты
Проведены интеграционные тесты для реализации репозиториев и юнит-тесты для внутренней бизнес-логики. 

Запуск всех тестов производится командой `go test ./...` из корня проекта.

Также проведено нагрузочное тестирование (результаты см. в конце)
